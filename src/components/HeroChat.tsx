...
import { Sparkles, Search, Send, ShoppingCart, Check, X, RotateCcw, ChevronRight } from 'lucide-react';
...
function ProductCard({ productId }: { productId: string }) {
    ...
    return (
        <motion.div
            ...
            className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-sm px-3 py-2.5 hover:bg-white/10 transition-colors"
        >
...
function AIMessage({ msg }: { msg: DisplayMessage }) {
                ...
                {expanded && (
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-4 py-2.5 border-t border-white/10">
                            <p className="text-[10px] text-white/30 font-medium">Powered by Gemini AI</p>
                            <button
                                onClick={handleReset}
